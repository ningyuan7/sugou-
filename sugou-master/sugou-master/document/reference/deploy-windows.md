...
- 导入项目，以maven项目形式导入  
    ![eclipse_import_1.png](https://github.com/macrozheng/sugou/blob/master/document/resource/eclipse_import_1.png)  
    ![eclipse_import_2.png](https://github.com/macrozheng/sugou/blob/master/document/resource/eclipse_import_2.png)
- 安装lombok插件，下载地址：https://projectlombok.org/downloads/lombok.jar  
- 下载完后双击，使用java程序打开
- 按照提示选择eclipse.exe的安装路径安装插件，完成后重启Eclipse
- 启动项目：右击com.macro.sugou.MallAdminApplication的main方法，选择run as Java Application
...
- 注意：如果你修改了sugou-search中的es的cluster-name: sugou-es，你需要在elasticsearch-6.2.2\config\elasticsearch.yml文件中修改cluster.name: sugou-es
...
- 创建用户并设置其角色为管理员：sugou sugou
    ![rabbitmq_install_2.png](https://github.com/macrozheng/sugou/blob/master/document/resource/rabbitmq_install_2.png)
- 创建virtual host:/sugou
    ![rabbitmq_install_3.png](https://github.com/macrozheng/sugou/blob/master/document/resource/rabbitmq_install_3.png)
- 给mall用户配置范围该virtual host的权限
    ![rabbitmq_install_4.png](https://github.com/macrozheng/sugou/blob/master/document/resource/rabbitmq_install_4.png)
...
- 首先将sugou-admin\src\main\resources\application.properties文件中以aliyun.oss.开头的配置改为你自己的配置
...
- 启动项目：直接运行com.macro.sugou.MallAdminApplication的main方法即可
- 接口文档地址：http://localhost:8080/swagger-ui.html

## sugou-search

- 启动项目：直接运行com.macro.sugou.search.MallSearchApplication的main方法即可
...
- 启动sugou-portal项目：直接运行com.macro.sugou.portal.MallPortalApplication的main方法即可
